                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        execCommand: 'git clone https://github.com/kaushikarvind/spring-petclinic.git && cd /tmp/spring-petclinic && sudo cp /tmp/target/springboot-petclinic-1.4.1.jar tmp/spring-petclinic/target/ && sudo java -jar springboot-petclinic-1.4.1.jar'
                                    )
                                ]
                            ) 
                        ]
